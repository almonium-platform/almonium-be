...
public class LoggingAspect {
    private static final String BASE_PACKAGE = "com.linguarium";
    private static final String FILTER_PATH = BASE_PACKAGE + ".config.security.jwt.TokenAuthenticationFilter";
    private static final String POINTCUT = "within(" + BASE_PACKAGE + "..*) && !within(" + FILTER_PATH + ")";

    @Pointcut(POINTCUT)
    public void publicMethod() {
        // Pointcut for public methods in com.linguarium package and sub-packages, excluding TokenAuthenticationFilter
    }
