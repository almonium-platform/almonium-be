...
public class OAuth2AuthenticationSuccessHandler extends SimpleUrlAuthenticationSuccessHandler {
	...
	@Autowired
	OAuth2AuthenticationSuccessHandler(TokenProvider tokenProvider, AuthenticationProperties authenticationProperties,
	...
	private boolean isAuthorizedRedirectUri(String uri) {
		...
		return authenticationProperties.getOauth2().getAuthorizedRedirectUris().stream().anyMatch(authorizedRedirectUri -> {
