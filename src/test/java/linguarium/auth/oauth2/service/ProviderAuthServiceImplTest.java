...
//
//        // Act & Assert
//        assertThatThrownBy(() -> userServiceSpy.authenticate(oAuth2UserInfo, attributes))
...
//
//        // Act
//        User result = authService.authenticate(oAuth2UserInfo, attributes);
//
//        // Assert
...
//                entry("aud", new
// String[]{"832714080763-hj64thg1sghaubbg9m6qd288mbv09li6.apps.googleusercontent.com"}),
