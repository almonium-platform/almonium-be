...
public class CardRepositoryTest {
    ...
    public void givenOwner_whenFindAllByOwner_thenShouldReturnCardsWithCorrectDetails() {
    ...
    public void givenOwnerAndLanguage_whenFindAllByOwnerAndLanguage_thenShouldReturnCardsWithCorrectDetails() {
    ...
    public void givenOwnerAndEntry_whenFindAllByOwnerAndEntryLikeIgnoreCase_thenShouldReturnMatchingCards() {
    ...
    public void givenPublicId_whenGetByPublicId_thenShouldReturnCorrectCard() {
